...
urlpatterns = [
    ...
    re_path(r'^MP_verify_pk5McDyW9NG1nDd4.txt$',TemplateView.as_view(template_name="MP_verify_pk5McDyW9NG1nDd4.txt", content_type="text/plain"), name="MP_verify_pk5McDyW9NG1nDd4.txt"),   #更换公众号需要修改 文件和名称都需要
]
